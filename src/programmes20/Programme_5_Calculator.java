...
public class Programme_5_Calculator {
    ...
    public static void main(String[] args) {
        ...
        int sunResult = subtraction(a, b);  //return type method printing in the statement below static
        System.out.println("The subtraction of " + a + "and " + b + "is : " + sunResult);

        Programme_5_Calculator obj = new Programme_5_Calculator();
        obj.multiplication(a,b);

        int divResult = obj.division(a, b);  //using object return type instance method
